 ...
 * 
 * <p>Java class for CursorFetchRequest complex type.
 * 
...
@XmlType(name = "CursorFetchRequest", namespace = "http://www.opengis.net/ols/nav", propOrder = {
    "cursorID",
    "fetchDirection",
    "numRecordsToFetch"
})
    ...
    extends AbstractRequestParametersType
{
    ...
    @XmlElement(name = "FetchDirection", required = true)
    protected FetchDirectionType fetchDirection;
    @XmlElement(name = "NumRecordsToFetch", required = true)
